...
function disableCards() {
    ...
    if (counter == 1) {
        ...
        document.querySelector(".progress-bar").style.height = "33.33%";
    } else if (counter == 3) {
        document.querySelector(".progress-bar").style.height = "50%";
    } else if (counter == 4) {
        document.querySelector(".progress-bar").style.height = "66.67%";
    } else if (counter == 5) {
        document.querySelector(".progress-bar").style.height = "83.33%";
    } else if (counter == 6) {
