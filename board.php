  ...
  <source src="images/song.mp3" type="audio/mpeg">
            ...
            <div class="modal-content">
                <div class="modal-body d-flex justify-content-center">
                    ...
                    <div class="row">
                        ...
                        <div class="col-4">
                            <button type="button" class="btn btn-primary" onclick="onResume();resumefunction()" class="button-6"><img src="images/play-2.jpg" alt="play" height="70px" width="70px" id="resume"></button>
                            <br/>
                            <h6>Resume</h6>
                            <br>
                        </div>
                        <div class="col-4 column">
                            <button type="button" class="btn btn-primary" onclick="restartfunction()" class="button-6"><img src="images/restart-2.jpg" alt="restart" height="70px" width="70px" id="resume"></button>
                            <br/>
                            <h6>Restart</h6>
                        </div>
                        <div class="col-4 column">
                            <button type="button" class="btn btn-primary" class="button-6"><a href="index.html"><img src="images/home-2.jpg" alt="home" height="70px" width="70px" id="resume"></a></button>
                            <br/>
                            <h6>Home</h6>
                        </div>
                    </div>
    ...
    <div class="right">
        ...
        <div class="button-pause">
            <href="#" id="pop"><img src="images/pause-final-new.jpg" alt="Pause-Button" class="pause" onclick="onPause(); pausemusic()"></a>
        </div>

        <div class="music">
            <!-- <img src="images/music-stop-3.jpg" alt="music-stop" class="front-face" id="music-icon-stop" onclick="playmusic()" /> -->
            <img src="images/music.jpg" alt="music" class="" id="music-icon" onclick="stopmusic()" />
        </div>
